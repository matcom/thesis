...
En la práctica la EA tiene un gran número de aplicaciones: (CITE \cite{janier2019argument} pag 5)
\begin{itemize}
...
El objetivo principal de este trabajo fue \emph{el diseño e implementación de un algoritmo para 
