...
% en Transformer y Attention (CITE \cite{mayer2020transformer}, \cite{galassi2021deep})
...
%     \item Introducir el tema de la argumentación en el PLN, su usos actuales e importancia.
