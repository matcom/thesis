...
% La notación empleada para la notación de escalares, vectores y matrices es la siguiente:
% \begin{itemize}
% 	\item $\textbf{x}$: Letras en minúsculas en negrita para vectores de de dimensión $1 \cross n$.
% 	\item $\textbf{W}$: Letras en mayúsculas en negrita para matrices de de dimensión $1 \cross n$.
% 	\item $b$: Letras en minúsculas para escalares.
% \end{itemize}
...
En PLN los datos suele estar representados a distintos niveles de granulidad.
